...
e.prototype.compileShader = function(t2, e2) {
  ...
  for (var i3 = this.geometry, r2 = this.multiplier, s2 = i3.vertices, n = i3.normal, a = new Float32Array(r2 * s2.length * e2.size), o = 0; o < r2; o += 1)
    for (var h = e2.data && e2.data(o, r2), u2 = o * s2.length * e2.size, f2 = 0; f2 < s2.length; f2 += 1)
